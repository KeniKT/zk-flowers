...
export default function RoseVarietiesSection() {
  ...
  const varieties = [
    {
      ...
      features: ["Premium deep red color", "Exceptional form", "Long vase life"],
      image: UpperClass,
    ...
    },
    {
      ...
      features: ["Vibrant red color", "Excellent bud formation", "Reliable quality"],
      image: Tecazi,
    ...
    },
    {
      ...
      features: ["Soft pink hue", "Delicate appearance", "Versatile use"],
      image: PinkTacazi,
    ...
    },
    {
      ...
      features: ["Unique color blend", "Large blooms", "Modern appeal"],
      image: Labell,
    ...
    },
    {
      ...
      features: ["Bright yellow color", "Large head size", "Cheerful appearance"],
      image: MoonWalk,
    ...
    },
    {
      ...
      features: ["Blush pink gradient", "Elegant appearance", "Graceful form"],
      image: PinkAthena,
    ...
    },
    {
      ...
      features: ["Pink-green mix", "Unique coloration", "Modern aesthetic"],
      image: BellaRose,
    ...
    },
    {
      ...
      features: ["Deep crimson color", "Intense saturation", "Long vase life"],
      image: EverRed,
    ...
    },
    {
      ...
      features: ["Light pink tone", "Romantic appeal", "Delicate petals"],
      image: Bisou,
    ...
    },
    {
      ...
      features: ["Orange-red blend", "Vibrant color", "Spanish inspiration"],
      image: Espana,
    ...
    },
    {
      ...
      features: ["Pure white petals", "Classic elegance", "Versatile use"],
      image: Athena,
  ...
  return (
    <motion.section 
      ...
      className="max-w-7xl mx-auto py-12 px-4 bg-gradient-to-b from-white via-green-50/30 to-white"
    >
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8 bg-white rounded-3xl shadow-2xl p-6 border border-green-100">
        ...
        >
          <motion.div 
            ...
            className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl group bg-gradient-to-br from-green-50 to-white border-4 border-white"
        ...
        >
          <div>
            ...
            >
              <span className="text-sm font-bold px-3 py-1 bg-green-100 rounded-full" style={{ color: '#15803d' }}>
                {varieties[selectedVariety].color}
              </span>
              <span className="text-gray-400 text-sm">•</span>
              <span className="text-gray-700 text-sm font-medium">{varieties[selectedVariety].headSize}</span>
              <span className="text-gray-400 text-sm">•</span>
              <span className="text-gray-700 text-sm font-medium">{varieties[selectedVariety].vaseLife}</span>
            </motion.div>
            <motion.p 
          ...
          >
            <motion.div 
              ...
              className="bg-gradient-to-br from-green-50 to-white p-3 rounded-xl shadow-lg border-2 border-green-200 hover:border-green-400 hover:shadow-xl transition-all"
            >
              <Ruler className="w-5 h-5 mb-2" style={{ color: '#14482E' }} />
              <div className="text-xs text-gray-600 mb-1 font-semibold uppercase tracking-wide">Lengths</div>
              <div className="text-xs font-bold" style={{ color: '#14482E' }}>
            ...
            >
              ...
              <div className="text-xs text-gray-600 mb-1 font-semibold uppercase tracking-wide">Vase Life</div>
              <div className="text-xs font-bold" style={{ color: '#14482E' }}>
          ...
          {/* Features - Compact 3-item design */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
            className="bg-gradient-to-br from-green-50 via-white to-green-50 p-4 rounded-xl shadow-lg border-2 border-green-200"
          >
            <h4 className="font-bold mb-3 text-base" style={{ color: '#14482E' }}>Key Features</h4>
            <div className="grid grid-cols-1 gap-2">
              {varieties[selectedVariety].features.map((feature, index) => (
                ...
                >
                  ...
                  <span className="text-xs text-gray-800 font-medium">{feature}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
