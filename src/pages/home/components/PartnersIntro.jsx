  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .animate-header { opacity: 0; animation: fadeInUp 0.8s ease-out forwards; }
        .animate-partner { opacity: 0; animation: fadeInLeft 0.6s ease-out forwards; }
        .animate-benefit { opacity: 0; animation: fadeInRight 0.6s ease-out forwards; }
        .animate-partner.animate-in, .animate-benefit.animate-in { opacity: 1; }
        .animate-button { opacity: 0; animation: fadeInUp 0.8s ease-out forwards; animation-delay: 1s; }
        .card-hover { transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
        .card-hover:hover { transform: translateY(-5px); box-shadow: 0 20px 40px rgba(5, 150, 105, 0.1); }
        .card-hover:hover .flag-image { animation: flagWave 1s ease-in-out; transform-origin: bottom center; }
        .icon-gradient {
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start mb-12">
          {/* Left column — partner card + Netherlands image */}
          <div className="space-y-6">
            ...
            {/* Netherlands image filling the gap */}
            <div className="relative rounded-2xl overflow-hidden shadow-lg border border-green-100" style={{ height: 220 }}>
              <img
              ...
              <div className="absolute bottom-4 left-5">
                <p className="text-white text-xs font-semibold uppercase tracking-widest opacity-80">Our Market</p>
                <p className="text-white text-xl font-bold">Netherlands</p>
              </div>
            </div>
          </div>
