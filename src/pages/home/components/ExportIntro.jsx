        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              roses to markets across Europe, with expanding reach into the Middle East.
            </p>

            {/* Markets Grid — 2 items, full width each */}
              ...
              {markets.map((market, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-green-900 text-lg">{market.name}</div>
